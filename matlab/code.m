...
fprintf('The classified output is : %f\n',Accuracy);
...
fprintf('The classified ME output is : %f\n',ME_Accuracy);
...
%       [ME_Diseasenet, ME_Diseasetraininfo] = trainNetwork(ME_DiseaseaugimdsTrain,ME_Diseaselayers,ME_Diseaseoptions);  %Train neural network for deep learning
       ...
       ME_StageMetrics.AUC = ME_AUC_Stage;
...
Glucoma_Metrics.AUC = Glucoma_AUC;
...
%       [Glucoma_Diseasenet, Glucoma_Diseasetraininfo] = trainNetwork(Glucoma_DiseaseaugimdsTrain,Glucoma_Diseaselayers,Glucoma_Diseaseoptions);  %Train neural network for deep learning
       ...
       [Glucoma_confMat_Stage, Glucoma_order] = confusionmat(Glucoma_Glucoma_YTest, Glucoma_YPredTest_Stage);

       
       % Calculate metrics
       Glucoma_TP_Stage = diag(Glucoma_confMat_Stage);
       Glucoma_FP_Stage = sum(Glucoma_confMat_Stage, 1)' - Glucoma_TP_Stage;
       Glucoma_FN_Stage = sum(Glucoma_confMat_Stage, 2) - Glucoma_TP_Stage;
       Glucoma_TN_Stage = sum(Glucoma_confMat_Stage(:)) - (Glucoma_TP_Stage + Glucoma_FP_Stage + Glucoma_FN_Stage);
       
       Glucoma_specificityP_Stage = Glucoma_TN_Stage ./ (Glucoma_TN_Stage + Glucoma_FP_Stage);
       Glucoma_sensitivityP_Stage = Glucoma_TP_Stage ./ (Glucoma_TP_Stage + Glucoma_FN_Stage);  % Sensitivity calculation
       Glucoma_precision_Stage = Glucoma_TP_Stage ./ (Glucoma_TP_Stage + Glucoma_FP_Stage);
       Glucoma_recall_Stage = Glucoma_TP_Stage ./ (Glucoma_TP_Stage + Glucoma_FN_Stage);
       Glucoma_f1_score_Stage = 2 * (Glucoma_precision_Stage .* Glucoma_recall_Stage) ./ (Glucoma_precision_Stage + Glucoma_recall_Stage);
       Glucoma_AUC_Stage = 0.5 * (Glucoma_TP_Stage ./ (Glucoma_TP_Stage + Glucoma_FN_Stage) + Glucoma_TN_Stage ./ (Glucoma_TN_Stage + Glucoma_FP_Stage));
       Glucoma_AUC_Stage = mean(Glucoma_AUC_Stage);
       ...
       Glucoma_StageMetrics.AUC = Glucoma_AUC_Stage;
...
Exudates_Metrics.AUC = Exudates_AUC;
...
%    
       ...
       [Exudates_confMat_Stage, Exudates_Exudates_order] = confusionmat(Exudates_Exudates_YTest, Exudates_YPredTest_Stage);

       % Calculate metrics
       Exudates_TP_Stage = diag(Exudates_confMat_Stage);
       Exudates_FP_Stage = sum(Exudates_confMat_Stage, 1)' - Exudates_TP_Stage;
       Exudates_FN_Stage = sum(Exudates_confMat_Stage, 2) - Exudates_TP_Stage;
       Exudates_TN_Stage = sum(Exudates_confMat_Stage(:)) - (Exudates_TP_Stage + Exudates_FP_Stage + Exudates_FN_Stage);
       
       Exudates_specificityP_Stage = Exudates_TN_Stage ./ (Exudates_TN_Stage + Exudates_FP_Stage);
       Exudates_sensitivityP_Stage = Exudates_TP_Stage ./ (Exudates_TP_Stage + Exudates_FN_Stage);  % Sensitivity calculation
       Exudates_precision_Stage = Exudates_TP_Stage ./ (Exudates_TP_Stage + Exudates_FP_Stage);
       Exudates_recall_Stage = Exudates_TP_Stage ./ (Exudates_TP_Stage + Exudates_FN_Stage);
       Exudates_f1_score_Stage = 2 * (Exudates_precision_Stage .* Exudates_recall_Stage) ./ (Exudates_precision_Stage + Exudates_recall_Stage);
       Exudates_AUC_Stage = 0.5 * (Exudates_TP_Stage ./ (Exudates_TP_Stage + Exudates_FN_Stage) + Exudates_TN_Stage ./ (Exudates_TN_Stage + Exudates_FP_Stage));
       Exudates_AUC_Stage = mean(Exudates_AUC_Stage);
       
       Exudates_StageMetrics.Accuracy = Exudates_DiseaseAccuracy;
       Exudates_StageMetrics.PSNR = Exudates_PSNR_Stage;
       Exudates_StageMetrics.Entropy = Exudates_Entropy_Stage;
       Exudates_StageMetrics.AUC = Exudates_AUC_Stage;
       ...
       Exudates_StageMetrics.Specificity = mean(Exudates_specificityP_Stage) * 100;
       Exudates_StageMetrics.Sensitivity = mean(Exudates_sensitivityP_Stage) * 100;
...
senderEmail = 'umapatasri6@gmail.com';  % Your Gmail email address
appPassword = 'plny okxr selt drwy';    % Your Gmail App Password
recipientEmail = 'umapatasri6@gmail.com';
