function generateDiagnosisGlaucoma_Reporthealthy(Glucoma_img, Glucoma_Segmented_Image, Glucoma_DiseaseYPred, Glucoma_TreatmentOptions, Glucoma_LifestyleRecommendations, Glucoma_Metrics)
...
hospitalName = Paragraph('EYE CARE HOSPITAL GLAUCOMA REPORT', 'Heading1'); 
...
imwrite(Glucoma_img, inputImgFileName); % Save input image
...
imwrite(Glucoma_Segmented_Image, outputImgFileName); % Save segmented image
